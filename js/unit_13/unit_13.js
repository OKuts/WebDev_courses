...
function f7() {
    let out = 0;
    let src = document.querySelector('.i-7').value;
...
function f8() {
    let out = 0;
    let src = document.querySelector('.i-8').value;
...
function f9() {
    let out = '';
    let src = document.querySelector('.i-9').value;
    for (let key in a9) {
        if (src == a9[key]) out += `${key} `;
    }
...
function f12() {
    let el = document.querySelector('.i-12').value;
    for (let key in a12) {
        if (el == a12[key]) delete a12[key];
    }
    f5(a12, '.out-12');
}
    ...
    if (station.length) {
        for (let key in a19) {
            for (let i = 0; i < a19[key].length; i++) {
                if (a19[key][i].toUpperCase() == station.toUpperCase()) {
                    out = key;
                }
            }
        }
