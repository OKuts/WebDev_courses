...
function f11() {
    let elem = d11.indexOf(+document.querySelector('.i-11').value);
    document.querySelector('.out-11').innerHTML = elem;
}
...
function f14() {
    d14.length = 0;
    let elem = +document.querySelector('.i-14').value;
...
function f15() {
    ...
    let index = d15.indexOf(elem);
    if (index == -1) d15.push(elem);
    showArr('.out-15', d15);
}
...
function f17() {
    for (let i = 0; i < d171.length; i++) d17.push(d171[i]);
    for (let i = 0; i < d172.length; i++) d17.push(d172[i]);
    showArr('.out-17', d17);
}
...
function f18() {
    let elem = document.querySelector('.i-18').value;
    document.querySelector('.out-18').innerHTML = d18.includes(elem);
}
