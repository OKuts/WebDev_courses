...
function f6() {
    let s6 = new Set(a6);
    document.querySelector('.out-6').innerHTML = a6.length - s6.size;
}
...
function f7() {
    ...
    let s7 = new Set(arrPassword);
    if (!(password.length - s7.size) && password.length > 6) {
...
function f11() {
    let s11 = new Set(a11);// элементы набора - массивы
    console.log(s11);
}
