...
function t10() {
    ...
    document.querySelector('.out-10').textContent = input.value * 10;
}
...
function t11() {
    ...
    document.querySelector('.out-11').textContent = +input.value + 10;
}
...
function t12() {
    let input = document.querySelector('.i-12_1');
    let input2 = document.querySelector('.i-12-2');
    document.querySelector('.out-12').textContent = 'Hello ' + input.value + ' ' + input2.value;
}
...
function t13() {
    let input = document.querySelector('.i-13_1');
    let input2 = document.querySelector('.i-13_2');
    document.querySelector('.out-13').textContent = +input.value + +input2.value;
}
...
function t16() {
    let input = document.querySelector('.i-16_1');
    let input2 = document.querySelector('.i-16_2');
    document.querySelector('.out-16').textContent = +input.value + +input2.value;
}
...
function t19() {
    let input = document.querySelector('.i-19_1');
    let input2 = document.querySelector('.i-19_2');
    document.querySelector('.out-19').textContent = +input.value + parseInt(input2.value);
}
...
function t20() {
    let name = document.querySelector('.i-20_1');
    let surname = document.querySelector('.i-20_2');
    let age = document.querySelector('.i-20_3');
    let business = document.querySelector('.i-20_4')
    document.querySelector('.out-20').textContent = 'Уважаемый ' + name.value + ' ' + surname.value + ' ваш возраст ' + age.value + ' года, по професси вы ' + business.value;
