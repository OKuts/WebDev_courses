...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=33&num2=-100')
        .then(data => data.text())
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=33&num2=-100')
        .then(data => data.text())
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=33&num2=-100')
        .then(data => data.text())
    ...
    fetch('http://getpost.itgid.info/index2.php',
        {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: 'auth=5ADcB96BA48d3f80&action=2&name=Olexandr'
        })
        .then(data => data.text())
    ...
    fetch('http://getpost.itgid.info/index2.php',
        {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: 'auth=5ADcB96BA48d3f80&action=3&num1=12&num2=77'
        })
        .then(data => data.text())
    ...
    fetch('http://getpost.itgid.info/index2.php',
        {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: 'auth=5ADcB96BA48d3f80&action=4&num1=12&num2=77'
        })
        .then(data => data.text())
    ...
    fetch('http://getpost.itgid.info/index2.php',
        {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: 'auth=5ADcB96BA48d3f80&action=6&num1=12&num2=77'
        })
        .then(data => data.text())
