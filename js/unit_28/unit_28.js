...
goods2 = new Goods('chicken', 234.1, './img/5.png', 64);
goods2.draw('.out-4');
...
goods3 = new Goods2('chicken', 234.1, './img/5.png', 64, true);
goods3.draw('.out-6');
...
let client = new Valid('ol.kuts@gmail.com', 'rador');
client.validate();
...
let client2 = new Valid('ol@gmail.com', 'radoree');
client2.validate();
console.log(client2.isValid);
...
let valid2 = new Valid2('', 'esfsfdsgfd');
valid2.validate();
console.log(valid2);
...
let valid3 = new Valid2('a@gmail.com', 'esfsfdsgfd');
valid3.validate();
console.log(valid3);