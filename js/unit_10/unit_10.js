...
let ar1 = ['Ivan', 5, true, 6, 'fara', false];
...
let ar2 = ['Ivan', 5, true, 6, 'fara', false];
...
let ar3 = ['Ivan', 5, true, 6, 'fara', false];
...
let ar4 = ['Ivan', 5, true, 6, 'fara', false, 75, -20, 'son', true];
...
let ar6 = ['Александр', 'Близнецы', 7, 6];
...
function f19() {
    ...
    for (let i = 1; i < ar19.length; i++) {
        if (ar19[i] < ar19[i_min]) i_min = i;
    }
    document.querySelector('.out-19').innerHTML = i_min;
}
