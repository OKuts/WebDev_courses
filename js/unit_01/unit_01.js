...
document.querySelector('.three').innerHTML = '<h3>three</h3>';
...
document.querySelector('.four').innerHTML = '<h4>four</h4>';
document.querySelector('.four').innerHTML += '<p>four +</p>';
...
let z1 = 6;
let z2 = 3;
document.querySelector('.out-18').innerHTML = z1 * z2;
...
let y1 = 6;
let y2 = 3;
document.querySelector('.out-2').innerHTML = y1 / y2;
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.out-5').innerHTML = x1 + x2;
