...
function f7() {
    ...
    if (document.querySelector('.i-7').value.length > 5) {
...
function f8() {
    ...
    out8.innerHTML = '<input type="text" class="i-81"><button class="b-81">innerHTML</button>';
...
function f16() {
    ...
    select = document.querySelector('.s-16').value;
...
function f17() {
    select = document.querySelector('.s-17').value;
...
function f18() {
    select = document.querySelector('.s-18').value;
